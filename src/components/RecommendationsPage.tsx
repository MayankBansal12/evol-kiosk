...
import { SurveyData, Product } from "@/types/survey";
...
const RecommendationsPage = ({ surveyData, onRestart }: RecommendationsPageProps) => {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-6">
            Based on your preferences for {surveyData.jewelryType} • {surveyData.occasion} • {surveyData.stylePreference}
          </p>
          <Badge variant="secondary" className="text-sm px-4 py-2">
            {surveyData.priceRange.replace('-', ' - $').replace('under', 'Under $').replace('over', 'Over $')}
          </Badge>
        </motion.div>
